			...
			if(gameVars.forest_appleTree > 0):
				...
				if tool == "1":
					if(durability.decreaseDurability(1,0,0,1,0,0,0) == True):
						...
						clock.setCounterDetails(0, "appletree stoneaxe")
						clock.setCounter(0, 1)
						gameVars.dayCounterActivated[0] = True
					else:
